...
@section('content')
    ...
    {!! Form::model($scheme, ['method' => 'PUT', 'route' => ['admin.schemes.update', $scheme->id], 'name' => 'frmSchemeCreate']) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('installment', old('installment'), ['class' => 'form-control moneyFormat text-right', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('value'))
                        <p class="help-block">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('value', old('value'), ['class' => 'form-control moneyFormat text-right', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('value'))
                        <p class="help-block">
                            {{ $errors->first('value') }}
